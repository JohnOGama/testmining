 ...
 */}
          ...
          >
            <div className="md:pr-4 lg:pr-12 xl:pr-16">
              ...
              <p className="text-xl text-gray-400 mb-4">
                The source of primary iron for the world's iron and steel
                industries. It is therefore essential for the production of
                steel, which in turn is essential to maintain a strong
                industrial base. Almost all (98%) iron ore is used in
                steelmaking. Iron ore is mined in about 50 countries.
              </p>
              <ul className="text-lg text-gray-400 -mb-2">
                <li className="flex items-center mb-2">
                  ...
                  <span>
                    abundant mineral on Earth, one of the main minerals used by
                    humans.
                  </span>
                </li>
                <li className="flex items-center mb-2">
                  ...
                  <span>
                    solid and durable material that has a wide range of uses.
                  </span>
                </li>
                <li className="flex items-center">
                  ...
                  <span>
                    relatively easy to mine and process, making it an excellent
                    choice for construction and other applications.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
          ...
          >
            <div className="md:pl-4 lg:pl-12 xl:pl-16">
              ...
              <p className="text-xl text-gray-400 mb-4">
                closing any gaps between your intentions and actions, ensuring
                your interactions with customers, employees, suppliers,
                investors and regulators are aligned with your stated aims and
                purpose
              </p>
              <ul className="text-lg text-gray-400 -mb-2">
                <li className="flex items-center mb-2">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
          ...
          >
            <Image
              className="max-w-full mx-auto md:max-w-none h-auto md:hidden lg:block"
              src={zgspeed1}
              width={540}
              height={600}
              alt="Features 03"
          ...
          >
            <div className="md:pr-4 lg:pr-12 xl:pr-16">
              ...
              <p className="text-xl text-gray-400 mb-4">
                can result lower delivery costs, more reliable delivery
                performance and better utilization of delivery resources.
                <br></br>
                route plan are data accuracy and route optimization software
                that can accurately model the physical and operational
                conditions and the flexibility to model business objectives, and
                a clear understanding of the desired business goals.
              </p>
              <ul className="text-lg text-gray-400 -mb-2">
                <li className="flex items-center mb-2">
                  <svg
                ...
                <li className="flex items-center">
                  ...
                  <span>
                    {" "}
                    Customer involvement in the process to know what is going
                    on.
                  </span>
                </li>
                <li className="flex items-center">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
          ...
          >
            <div className="md:pl-4 lg:pl-12 xl:pl-16">
              ...
              <p className="text-xl text-gray-400 mb-4 ">
                Generally, any materials can be made into biomass pellets as
                long as it will burn. Traditional materials for fuel pellets are
                made out of wood from the forest industry residue and now
                agri-waste can be made into biomass pellets. Also paper and
                plastic pellets are made from municipal solid waste. We go one
                step further and use mixed municipal solid waste, which include
                textiles, plastics, food waste and household waste. Combined
                with our patented burners, will burn cleaner and more efficient
                than traditional burners and biomass pellets. If correctly
                managed, biomass is a sustainable fuel that can deliver a
                significant reduction in net carbon emissions as compared to
                fossil fuels. The amount of CO2-neutral fuel produced with
                equipment from ZecoWaste in time will be able to replace
                millions tons of oil per year.
              </p>
              <ul className="text-lg text-gray-400 -mb-2">
                <li className="flex items-center mb-2">
                  <svg
                ...
                <li className="flex items-center mb-2">
                  ...
                  <span>
                    Environmentally friendly, which is free of contaminants and
                    burns cleanly with very low ash
                  </span>
                </li>
                <li className="flex items-center mb-2">
                  <svg
                  ...
                  <span>
                    Renewable that is sustainable biomass from solid municipal
                    waste
                  </span>
                </li>
                <li className="flex items-center mb-2">
                  ...
                  <span>
                    Efficient with consistant quality and moisture content
                  </span>
                </li>
                <li className="flex items-center">
                  <svg
                  ...
                  <span>
                    Econimical with attactive colorific value which greatly
