  ...
  return (
    <section>
      <div className="w-full mx-auto relative ">
        {/* Hero content */}
        <div className="pt-40  md:pt-50 md:pb-16 lg:ml-[570px]">
          {/* Section header */}
          <div className="mx-auto text-gray-800 md:pb-10 lg:flex lg:flex-col lg:justify-center lg:items-center ">
            <h1 className="text-5xl">Let's talk your requirement</h1>
            <p className="text-6sm text-gray-800 mb-8 ">
              Mining , Construction and Waste Management Industry is our
              expertise. Making the complex simple.
            </p>
            <div className="text-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div className="flex">
                <a
                  className="btn text-white w-22 h-20 "
                  href="#0"
                  style={{ backgroundColor: "#08c5d6" }}
                >
                  {/* 
