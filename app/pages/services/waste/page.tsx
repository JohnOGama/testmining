      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-10 md:pb-20">
          ...
          <div>
            <br></br>
            <br></br>
            <h5 className="h4 text-black">WASTE MANAGEMENT</h5>
            <h6 className="h6 text-black">
              ...
              prevent waste. It is also an approach where companies implement
              comprehensive strategies to efficiently manage wastes from their
              origin until their final disposal. Possible waste disposal methods
              are recycling, composting, incineration, landfills,
